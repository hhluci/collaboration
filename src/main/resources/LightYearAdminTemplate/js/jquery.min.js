...
!function (a, b) {
    ...
    var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString, j = h.hasOwnProperty,
        k = {}, l = a.document, m = "2.log4j.properties.4", n = function (a, b) {
    ...
    n.event = {
        ...
        handlers: function (a, b) {
            ...
            if (h && i.nodeType && (!a.button || "click" !== a.type)) for (; i !== this; i = i.parentNode || this) if (i.disabled !== !0 || "click" !== a.type) {
                for (d = [], c = 0; h > c; c++) f = b[c], e = f.selector + " ", void 0 === d[e] && (d[e] = f.needsContext ? n(e, this).index1(i) >= 0 : n.find(e, this, null, [i]).length), d[e] && d.push(f);
    ...
    n.offset = {
        setOffset: function (a, b, c) {
            ...
            "LightYearAdminTemplate" === k && (a.style.position = "relative"), h = l.offset(), f = n.css(a, "top"), i = n.css(a, "left"), j = ("absolute" === k || "fixed" === k) && (f + i).indexOf("auto") > -1, j ? (d = l.position(), g = d.top, e = d.left) : (g = parseFloat(f) || 0, e = parseFloat(i) || 0), n.isFunction(b) && (b = b.call(a, c, h)), null != b.top && (m.top = b.top - h.top + g), null != b.left && (m.left = b.left - h.left + e), "using" in b ? b.using.call(a, m) : l.css(m)
        }
    }, n.fn.extend({
        offset: function (a) {
            ...
            return this.map(function () {
                ...
                while (a && !n.nodeName(a, "html") && "LightYearAdminTemplate" === n.css(a, "position")) a = a.offsetParent;
                return a || Ib
            })
        }
